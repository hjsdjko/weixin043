	...
	<view class="content">
		<view :style='{"width":"100%","padding":"0 0 0 0","position":"relative","background":"#ffffff","height":"100%"}'>
			...
			<view class="news-box3" :style='{"width":"100%","padding":"24rpx 24rpx 24rpx 24rpx","margin":"40rpx 0 40rpx 0","height":"auto","order":"10"}'>
				<view @tap="onDetailTap(product)" v-for="(product,index) in list" :key="index" class="list-item" :style='{"padding":"0px 12rpx 0px 12rpx","margin":"0 0 0 0","borderColor":"#ddd","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 2rpx 0","display":"flex","width":"100%","position":"relative","borderStyle":"dashed","justifyContent":"space-between","height":"100rpx"}'>
					<view :style='{"padding":"0 0 0 0","boxShadow":"4rpx 0 4rpx #999999","margin":"44rpx 20rpx 0 0","backgroundColor":"#3691a090","borderRadius":"12rpx","width":"12rpx","height":"12rpx"}' class="dian"></view>
					...
					<view class="iconfont icon-gengduo2" :style='{"width":"32rpx","padding":"0 0 0 0","margin":"0px 0 0 0","lineHeight":"100rpx","fontSize":"32rpx","color":"#ccc"}'></view>
				</view>
			</view>
